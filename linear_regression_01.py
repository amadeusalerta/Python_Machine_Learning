...
x_train,x_test,y_train,y_test=tts(aylar,satislar,test_size=0.33,random_state=0)
...
y_train=standant_calculation.fit_transform(y_train)
y_test=standant_calculation.fit_transform(y_test)
